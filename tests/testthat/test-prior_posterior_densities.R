...
testthat::test_that("prior_posterior_densities throws error if predictors_col_name and
                    half_max_label are not characters",{
  testthat::expect_error(expect_gg(BayesPharma::prior_posterior_densities(test_model,
