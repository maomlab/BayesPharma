...
testthat::test_that("density_distributions throws error if predictors_col_name
                     and half_max_label are not characters", {
  testthat::expect_error(expect_gg(BayesPharma::density_distributions(
    test_model,
