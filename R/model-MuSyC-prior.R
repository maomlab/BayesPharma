...
#'
#' @param logE0 numeric or \code{brms::prior(...)}. Prior for the log
#'     response with no treatment. Default normal(log(0.5), 3) lower
#'     bounded by 0.
#' @param logE1 numeric or \code{brms::prior(...)}. Prior for the full
#'     log response for treatment 1 and the dose of treatment 2 is
#'     zero. Default normal(log(0.25), 3) lower bounded by 0.
#' @param logC1 numeric or \code{brms::prior(...)}. Prior for the log
#'     IC50 of drug 1 Default to normal(log(1), 3).
#' @param h1 numeric or \code{brms::prior(...)}. Prior the slope of
...
#' @param logE2 numeric or \code{brms::prior(...)}. Prior for the full
#'     log response for treatment 2 and the dose of treatment 1 is
#'     zero. Default normal(log(0.25), 3) lower bounded by 0.
#' @param logC2 numeric or \code{brms::prior(...)}. Prior for the log
#'     IC50 of drug 2 Default to normal(log(1), 3).
#' @param h2 numeric or \code{brms::prior(...)}. Prior the slope of
...
#'     bounded by 0.1
#' @param logE3 numeric or \code{brms::prior(...)}. Prior for the low
#'     full response for treatment 1 and treatment 2. Default to
#'     \code{normal(log(0.25), 3)} lower bounded by 0.
#' @param logalpha numeric or \code{brms::prior(...)}. Prior for the
