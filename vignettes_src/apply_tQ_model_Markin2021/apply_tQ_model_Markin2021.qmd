...
model_example <- BayesPharma::tQ_model(
  ...
  init = list(
    b_kcat = \() stats::runif(n = 1, 70, 110),
    b_kM = \() stats::runif(n = 1, 70, 110),
...
model_wt_mcmc <- BayesPharma::tQ_model(
  ...
  init = list(
    b_kcat = \() stats::runif(n = 1, 80, 120),
    b_kM = \() stats::runif(n = 1, 60, 100),
    sigma = \() stats::runif(n = 1, 0, 2)) |>
    "class<-"("bpinit"),
  cores = 8,
  threads = 2,
...
model_wt_mcmc_wide <- BayesPharma::tQ_model(
  ...
  init = list(
    b_kcat = \() stats::runif(n = 1, 100, 140),
    b_kM = \() stats::runif(n = 1, 60, 100),
    sigma = \() stats::runif(n = 1, 0, 20)) |>
    "class<-"("bpinit"),
  cores = 8,
  threads = 2,
  control = NULL,
