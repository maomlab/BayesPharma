...
The `BayesPharma` package aims to make Bayesian modeling for pharmacology more accessible. To do this, it makes easy to use interfaces for foundational dose-response type models. By building on the powerful Stan/BRMS framework, BayesPharma can be light-weight and adaptable to more advanced use cases while being computationally efficient and powerful.
