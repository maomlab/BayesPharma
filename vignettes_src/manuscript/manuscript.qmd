...
abstract: |
  ...
  is an \texttt{R} package to analyzing pharmacology data using Bayesian
  methods. It is built around the \texttt{Stan} ecosystem and facilitates a
  principled Bayesian workflow. BayesPharma can be used to fit and analyze
  foundational pharmacology models; serve as a pedagogical framework for
  learning Bayesian methods; and help build and analyzing sophisticated
