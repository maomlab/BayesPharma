...
```{r default-init, warning=FALSE, message=FALSE}
...
```{r sample-prior, results='hide', message=FALSE, cache=TRUE}
...
```{r model-posterior-densities, message=FALSE, warning=FALSE}
...
```{r model2, results='hide', message=FALSE, cache=TRUE}
kor_sample_priors <- BayesPharma::dr_model(
  kor_antag,
  BayesPharma::dr_formula(), 
  priors = kor_priors2,
