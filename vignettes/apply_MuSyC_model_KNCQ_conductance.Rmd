...
```
## Error in here("vignettes", "apply_MuSyC_model_KCNQ_conductance_files/"): could not find function "here"
```
...
```
## Error in brms::expose_functions(model, vectorize = TRUE): object 'model' not found
```
