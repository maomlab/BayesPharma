...
```{r}
damgo <- BayesPharma::calculate_log_dose(model = damgo, dose_col = dose_nM, 
                                         molar_concentration = 1)
damgo <- BayesPharma::change_col_names(model = damgo, 
...
```{r}
sampling_priors <- BayesPharma::dr_model(model = damgo,
                                         model_name = damgo1, 
                                         formula = dr_formula(),
                                         priors = damgo_priors,
                                         inits = damgo_inits,
...
damgo_model <- BayesPharma::dr_model(model = damgo,
                                     model_name = damgo1,
                                     formula = dr_formula(),
                                     priors = damgo_priors,
                                     inits = damgo_inits)
...
```{r}
BayesPharma::traceplot(damgo_model, "_Intercept", half_max_label = "ic50")
```
...
BayesPharma::plot_draws_data(model = damgo_model,
                             n = 100,
                             lower = -9,
                             upper = -3,
