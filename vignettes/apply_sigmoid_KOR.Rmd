...
package from a study performed by Margolis et
...
Originally, the dose-response data analysis was performed by using
...
## ic50_substance_idBTRX_335140      -8.85      0.20    -9.21    -8.40 1.00    14899     9316
## ic50_substance_idBTRX_395750      -8.24      0.46    -8.93    -7.36 1.00    12120     5841
## ic50_substance_idJNJ              -9.15      0.32    -9.79    -8.50 1.00    15256    10460
## ic50_substance_idPF               -6.18      1.02    -7.67    -3.58 1.00     8272     5238
## hill_substance_idBTRX_335140      -1.47      0.60    -2.88    -0.58 1.00    14995    11321
## hill_substance_idBTRX_395750      -0.90      0.51    -2.26    -0.26 1.00    10375     5911
## hill_substance_idJNJ              -1.01      0.52    -2.41    -0.41 1.00    14910    10490
## hill_substance_idPF               -0.31      0.24    -0.90    -0.03 1.00     8047     4787
## bottom_substance_idBTRX_335140    -0.01      0.50    -0.98     0.96 1.00    17281    11401
## bottom_substance_idBTRX_395750     0.01      0.50    -0.97     0.99 1.00    17587    11876
## bottom_substance_idJNJ            -0.01      0.50    -0.99     0.96 1.00    16805    10580
## bottom_substance_idPF              0.01      0.50    -0.97     0.99 1.00    19948    11245
...
##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sigma    32.16      2.86    27.17    38.31 1.00    14530    10557
## 
...
## Chain 1: 
## Chain 1:  Elapsed Time: 2.759 seconds (Warm-up)
## Chain 1:                2.503 seconds (Sampling)
## Chain 1:                5.262 seconds (Total)
## Chain 1: 
## 
...
## Chain 2: 
## Chain 2:  Elapsed Time: 2.828 seconds (Warm-up)
## Chain 2:                2.751 seconds (Sampling)
## Chain 2:                5.579 seconds (Total)
## Chain 2: 
## 
...
## Chain 3:                2.084 seconds (Sampling)
## Chain 3:                5.007 seconds (Total)
## Chain 3: 
## 
...
## Chain 4: 
## Chain 4:  Elapsed Time: 3.161 seconds (Warm-up)
## Chain 4:                2.391 seconds (Sampling)
## Chain 4:                5.552 seconds (Total)
## Chain 4:
##  Family: gaussian 
##   Links: mu = identity; sigma = identity 
## Formula: response ~ sigmoid(ic50, hill, top, bottom, log_dose) 
...
## ic50_substance_idBTRX_335140      -8.81      0.22    -9.22    -8.36 1.00
## ic50_substance_idBTRX_395750      -8.58      0.31    -9.16    -7.95 1.00
## ic50_substance_idJNJ              -8.95      0.31    -9.53    -8.32 1.00
## ic50_substance_idPF               -8.18      0.45    -9.08    -7.32 1.00
## hill_substance_idBTRX_335140      -1.19      0.36    -1.96    -0.57 1.00
## hill_substance_idBTRX_395750      -1.06      0.39    -1.91    -0.42 1.00
## hill_substance_idJNJ              -0.85      0.33    -1.68    -0.39 1.00
## hill_substance_idPF               -0.72      0.45    -1.73    -0.08 1.00
## bottom_substance_idBTRX_335140     1.73     10.55   -19.25    21.97 1.00
## bottom_substance_idBTRX_395750    15.46     11.14    -7.33    36.36 1.00
## bottom_substance_idJNJ            -2.88      9.77   -22.88    15.44 1.00
## bottom_substance_idPF             31.36     11.53     7.09    52.03 1.00
...
##                                Bulk_ESS Tail_ESS
## ic50_substance_idBTRX_335140      14132    11090
## ic50_substance_idBTRX_395750      14373    11993
## ic50_substance_idJNJ              13025    11727
## ic50_substance_idPF               14181    11917
## hill_substance_idBTRX_335140      14765     9899
## hill_substance_idBTRX_395750      14675    10859
## hill_substance_idJNJ              13702    12566
## hill_substance_idPF                9466     6053
## bottom_substance_idBTRX_335140    14230    11874
## bottom_substance_idBTRX_395750    14682    10484
## bottom_substance_idJNJ            12495    11162
## bottom_substance_idPF             11181    10516
...
## Family Specific Parameters: 
##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sigma    31.87      2.84    26.87    37.98 1.00    15342    10954
## 
## Draws were sampled using sampling(NUTS). For each parameter, Bulk_ESS
## and Tail_ESS are effective sample size measures, and Rhat is the potential
## scale reduction factor on split chains (at convergence, Rhat = 1).
...
is good, between `0.5` and `0.7` is OK, and higher than `0.7`
