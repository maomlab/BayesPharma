...
{{< include BayesPharma_manuscript_sections/introduction.qmd >}}

# Case Studies

In this section we will consider several models as case studies: the
sigmoidal hill model in #{sec:hill}, the MuSyC synergy model in
{#sec:MuSyC}, Michaelis-Menten enzyme progress curve in
#{sec:michaelis_menten}. For each we will implement it, and apply it
to example data by fitting different models and then we will compare
the models based on their fit of the data and inferences that can be
made.

{{< include BayesPharma_manuscript_sections/case_study_hill.qmd >}}

{{< include BayesPharma_manuscript_sections/case_study_synergy.qmd >}}

{{< include BayesPharma_manuscript_sections/case_study_kinetics.qmd >}}

{{< include BayesPharma_manuscript_sections/case_study_negbinom.qmd >}}
