...
```
##   time    P_true          P ST ET
## 1 0.00 0.0000000 -0.9174538 10 10
## 2 0.05 0.7311578  0.2313612 10 10
## 3 0.10 1.4243598  1.5581905 10 10
## 4 0.15 2.0794197  2.8438397 10 10
## 5 0.20 2.6964485  2.9355768 10 10
## 6 0.25 3.2758537  2.6146258 10 10
```
...
```
## Error in tidybayes::tidy_draws(model_single_prior): object 'model_single_prior' not found
```

```
## Error in tidybayes::tidy_draws(model_single): object 'model_single' not found
```


```
## Error in fortify(data): object 'draws_single_prior' not found
```
...
```
## Error in tidyr::pivot_wider(draws_single_prior, id_cols = c(".chain", : object 'draws_single_prior' not found
```

```
## Error in tidyr::pivot_wider(draws_single_posterior, id_cols = c(".chain", : object 'draws_single_posterior' not found
```

```
## Error in fortify(data): object 'draws_single_prior_pairs' not found
```
...
```
## Error in update(model_multiple, sample_prior = "only"): object 'model_multiple' not found
```


```
## Error in tidybayes::tidy_draws(model_multiple_prior): object 'model_multiple_prior' not found
```

```
## Error in tidybayes::tidy_draws(model_multiple): object 'model_multiple' not found
```


```
## Error in tidyr::pivot_wider(draws_multiple_prior, id_cols = c(".chain", : object 'draws_multiple_prior' not found
```

```
## Error in tidyr::pivot_wider(draws_multiple_posterior, id_cols = c(".chain", : object 'draws_multiple_posterior' not found
```

```
## Error in fortify(data): object 'draws_multiple_prior_pairs' not found
```
...
```
## Error in dplyr::transmute(draws_multiple_posterior, draw = .draw, variable = stringr::str_replace(stringr::str_replace(.variable, : object 'draws_multiple_posterior' not found
```

```
## Error in dplyr::mutate(sample_multiple, ET_label = forcats::fct_inorder(paste0("ET: ", : object 'sample_multiple' not found
```
