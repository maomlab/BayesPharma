...
```
## Loading 'brms' package (version 2.18.1). Useful instructions
...
```
##   time    P_true          P ST ET
## 1 0.00 0.0000000 -0.4834701 10 10
## 2 0.05 0.7311578  0.5434683 10 10
## 3 0.10 1.4243598  1.3900547 10 10
## 4 0.15 2.0794197  1.4740040 10 10
## 5 0.20 2.6964485  2.1198875 10 10
## 6 0.25 3.2758537  3.6310486 10 10
```
...
## kcat_Intercept     2.88      0.41     2.19     3.82 1.00     1245     1320
## kM_Intercept       4.32      1.90     1.41     8.77 1.00     1274     1350
## 
## Family Specific Parameters: 
##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sigma     0.54      0.05     0.45     0.65 1.00     1904     1779
## 
...
## Chain 3 Iteration: 1800 / 2000 [ 90%]  (Sampling) 
## Chain 1 Iteration: 2000 / 2000 [100%]  (Sampling) 
## Chain 1 finished in 85.8 seconds.
## Chain 4 Iteration: 1900 / 2000 [ 95%]  (Sampling) 
## Chain 2 Iteration: 2000 / 2000 [100%]  (Sampling) 
## Chain 2 finished in 87.8 seconds.
## Chain 3 Iteration: 1900 / 2000 [ 95%]  (Sampling) 
## Chain 4 Iteration: 2000 / 2000 [100%]  (Sampling) 
## Chain 4 finished in 92.2 seconds.
## Chain 3 Iteration: 2000 / 2000 [100%]  (Sampling) 
## Chain 3 finished in 94.6 seconds.
## 
## All 4 chains finished successfully.
## Mean chain execution time: 90.1 seconds.
## Total execution time: 94.7 seconds.
```
...
## Population-Level Effects: 
##                Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## kcat_Intercept     2.78      0.04     2.69     2.86 1.00     1307     1387
## kM_Intercept       4.53      0.30     3.96     5.14 1.00     1321     1401
## 
## Family Specific Parameters: 
##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sigma     0.58      0.02     0.55     0.62 1.00     2026     1636
## 
## Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
## and Tail_ESS are effective sample size measures, and Rhat is the potential
## scale reduction factor on split chains (at convergence, Rhat = 1).
