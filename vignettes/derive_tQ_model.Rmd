...
```
##   time    P_true          P ST ET
## 1 0.00 0.0000000 -0.3603244 10 10
## 2 0.05 0.7311578  0.7824004 10 10
## 3 0.10 1.4243598  1.1554061 10 10
## 4 0.15 2.0794197  1.2971427 10 10
## 5 0.20 2.6964485  2.1750147 10 10
## 6 0.25 3.2758537  2.9933570 10 10
```
...
## Chain 4 finished in 52.0 seconds.
## 
...
## kcat_Intercept     2.81      0.39     2.17     3.72 1.00     1178     1360
## kM_Intercept       4.35      1.85     1.54     8.83 1.00     1178     1402
## 
## Family Specific Parameters: 
##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sigma     0.42      0.04     0.35     0.51 1.00     1699     1407
## 
...
## Chain 3 Iteration: 1900 / 2000 [ 95%]  (Sampling) 
## Chain 4 Iteration: 2000 / 2000 [100%]  (Sampling) 
## Chain 4 finished in 103.3 seconds.
## Chain 1 Iteration: 1800 / 2000 [ 90%]  (Sampling) 
## Chain 2 Iteration: 2000 / 2000 [100%]  (Sampling) 
## Chain 2 finished in 104.4 seconds.
## Chain 3 Iteration: 2000 / 2000 [100%]  (Sampling) 
## Chain 3 finished in 106.5 seconds.
## Chain 1 Iteration: 1900 / 2000 [ 95%]  (Sampling) 
## Chain 1 Iteration: 2000 / 2000 [100%]  (Sampling) 
## Chain 1 finished in 114.5 seconds.
## 
## All 4 chains finished successfully.
## Mean chain execution time: 107.2 seconds.
## Total execution time: 114.6 seconds.
```
...
## Population-Level Effects: 
##                Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## kcat_Intercept     2.80      0.04     2.72     2.88 1.00     1463     1595
## kM_Intercept       4.48      0.28     3.94     5.04 1.00     1476     1554
## 
## Family Specific Parameters: 
##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
## sigma     0.56      0.02     0.53     0.59 1.00     1968     1768
## 
## Draws were sampled using sample(hmc). For each parameter, Bulk_ESS
## and Tail_ESS are effective sample size measures, and Rhat is the potential
## scale reduction factor on split chains (at convergence, Rhat = 1).
